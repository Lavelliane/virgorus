                    ...
                    <div>
                        <Tooltip
                            ...
                            content={
                                ...
                                <div className="text-tiny text-black w-48 text-justify">Estimated duration of the tour. This may change during the actual tour.</div>
                                </div>
                            }
                        >
                            <Button variant="light" className='h-8' disableAnimation>
                                <span className='text-lg flex items-center'><MdTimelapse /></span><span className='text-md flex items-center'>Duration: {foo}</span>
                            </Button>
                        </Tooltip>
                    </div>
                    <div>
                        <Tooltip
                            ...
                            content={
                                ...
                                <div className="text-tiny text-black w-48 text-justify">For a full refund, cancel at least 48 hours in advance of the start date of the experience.</div>
                                </div>
                            }
                        >
                            <Button variant="light" className='h-8' disableAnimation>
                                <span className='text-lg flex items-center'><MdCancel /></span><span className='text-md flex items-center'>48-hour cancellation</span>
                            </Button>
                        </Tooltip>
                    </div>
                    <div>
                        <Tooltip
                            ...
                            content={
                                ...
                                <div className="text-tiny text-black w-48 text-justify">Certain locations in the package have age requirements which you are required to abide by.</div>
                                </div>
                            }
                        >
                            <Button variant="light" className='h-8' disableAnimation>
                                <span className='text-lg flex items-center'><MdOutlineGroups /></span><span className='text-md flex items-center'>Ages {foo}</span>
                            </Button>
                        </Tooltip>
                    </div>
                    <div>
                        <Tooltip
                            ...
                            content={
                                ...
                                <div className="text-tiny text-black w-48 text-justify">The languages your tour guide is proficient in. Feel free to ask them anything about the tour.</div>
                                </div>
                            }
                        >
                            <Button variant="light" className='h-8' disableAnimation>
                                <span className='text-lg flex items-center'><MdLanguage /></span><span className='text-md flex items-center'>Live guide: {foo}</span>
                            </Button>
                        </Tooltip>
                    </div>
                </div>
